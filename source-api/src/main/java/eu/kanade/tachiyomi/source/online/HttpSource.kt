...
abstract class HttpSource : CatalogueSource {
     ...
     */
    protected val preferences: android.content.SharedPreferences by lazy {
        Injekt.get<android.app.Application>().getSharedPreferences("source_$id", android.content.Context.MODE_PRIVATE)
    }
